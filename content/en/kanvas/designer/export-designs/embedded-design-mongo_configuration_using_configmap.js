...
const data = {
              ...
              '7076b7bc-1c3a-47b6-ab08-d241ecd3563e': {
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 225.32354105155832, posY: -45.77549682706341 },
                    whiteboardData: {
                      style: {
          ...
          config: {
            ...
            services: {
              '28c3c45f-78b9-4fb9-8364-5852c5f6abbe': {
                settings: { 'role Ref': {}, subjects: [], name: 'cluster-role-binding-gl' },
                traits: {
                  meshmap: {
                    edges: [],
                    id: '28c3c45f-78b9-4fb9-8364-5852c5f6abbe',
                    ...
                    position: { posX: 262.0011242882803, posY: -77.59817960691944 },
              ...
              'dc88aa0f-877e-4156-a553-2cb99cbf7a30': {
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: -123.19101926767942, posY: -38.28999466205506 },
              ...
              '821622d3-c11c-47b8-8a7c-2684ae417fb4': {
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 167.86088463552468, posY: -61.137086573621424 },
          ...
          config: {
            ...
            services: {
              'a488249f-e3dd-47d2-a4f7-1ccc0a33fb03': {
                namespace: 'default',
                settings: { name: 'a488249f-e3dd-47d2-a4f7-1ccc0a33fb03', namespace: 'default' },
                traits: {
                  meshmap: {
                    edges: [],
                    id: 'a488249f-e3dd-47d2-a4f7-1ccc0a33fb03',
                    ...
                    position: { posX: 321.5035351717317, posY: 97.5206142006835 },
                    whiteboardData: {
                      style: {
                        backgroundColor: 'rgb(0,0,255)',
                        backgroundOpacity: '0.1',
              ...
              '502d200a-0399-453e-9c7d-1c4e3942e371': {
                ...
                traits: {
                  meshmap: {
                    ...
                    position: { posX: 259.0162774697714, posY: -3.248445537238163 },
          ...
          config: {
            ...
            services: {
              'a42cafe0-2ea7-4303-9769-38d9959927ce': {
                namespace: 'node-ic',
                settings: {
                  data: { 'mongo-password': 'bW9uZ29wYXNzd29yZA==', mongo_user: 'bW9uZ291c2Vy' },
                  type: 'Opaque',
                  name: 'secret-tn',
                  namespace: 'node-ic',
                ...
                traits: {
                  meshmap: {
                    ...
                    'meshmodel-metadata': {
                      ...
                      svgWhite: 'ui/public/static/img/meshmodels/kubernetes/color/secret-color.svg'
                    },
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -159.685522655395, posY: -10.857748424986724 },
          ...
          config: {
            ...
            services: {
              'a141c828-5946-4aed-a1be-1b913ed7d149': {
                namespace: 'node-ic',
                settings: { spec: {}, name: 'csi-driver-gv', namespace: 'node-ic' },
                traits: {
                  meshmap: {
                    edges: [],
                    id: 'a141c828-5946-4aed-a1be-1b913ed7d149',
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -72.44137416036641, posY: 20.252177084534885 },
              ...
              '9724a37e-beda-4a92-a6be-98a7ce0fa62a': {
                ...
                traits: {
                  meshmap: {
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -147.8710745397471, posY: -89.5191270895006 },
              ...
              '56f8f499-7dc8-4883-84ca-07feed4f270c': {
                ...
                traits: {
                  meshmap: {
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -238.0539029801771, posY: 24.045245554895626 },
              ...
              'd69c3fe2-a011-452d-b3d7-3f14eb6ce950': {
                ...
                settings: {
                  spec: {
                    'access Policy': {
                      subjects: [
                        { kind: 'Deployment', name: 'mongo-deployment', namespace: 'mongo' }
                      ]
                    },
                    database: {
                    ...
                    init: {
                      ...
                      script: {
                        cephfs: { monitors: [] },
                        'config Map': { 'default Mode': 1, items: [], name: 'config-map' },
                        'downward API': { items: [] },
                        ephemeral: {
                          'volume Claim Template': {
                            metadata: { finalizers: [] },
                            spec: { 'access Modes': [], selector: { 'match Expressions': [] } }
                          }
                        },
                        ...
                        'pod Template': {
                          ...
                          spec: {
                            ...
                            containers: [],
                            'dns Config': { nameservers: [], options: [], searches: [] },
                            'ephemeral Containers': [],
                            'host Aliases': [],
                            'image Pull Secrets': [],
                            'init Containers': [],
                            'readiness Gates': [],
                            'security Context': { 'supplemental Groups': [], sysctls: [] },
                            tolerations: [],
                    ...
                    'vault Ref': { name: 'mongo-secret', namespace: 'mongo-password  ' }
                  },
                  name: 'mongo-db-database-dk',
                  namespace: 'node-ic'
                },
                traits: {
                  meshmap: {
                    ...
                    label: 'mongo-db-database-dk',
                    'meshmodel-data': {
                      category: { metadata: null, name: 'App Definition and Development' },
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -232.28053031124452, posY: -56.89898518747992 },
              ...
              'cron-job-wh-0.601179249819543': {
                ...
                traits: {
                  meshmap: {
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -7.32813555518176, posY: -118.62523487900575 },
              ...
              '169581bc-6488-47cf-9c23-c450ab7f1fae': {
                ...
                traits: {
                  meshmap: {
                    ...
                    parent: 'dc88aa0f-877e-4156-a553-2cb99cbf7a30',
                    position: { posX: -72.32813555518176, posY: -53.62523487900575 },
                    whiteboardData: { style: { 'z-index': 21 } }
                  }
                },
                type: 'CronJob'
  ...
  elementStyles: {
    ...
    'a141c828-5946-4aed-a1be-1b913ed7d149': {
      ...
      'outline-offset': '0px',
      outlineOffset: '0px',
      'background-image': 'url(data:text/plain;base64,NDA0IHBhZ2Ugbm90IGZvdW5kCg==)',
      backgroundImage: 'url(data:text/plain;base64,NDA0IHBhZ2Ugbm90IGZvdW5kCg==)',
      'background-image-crossorigin': 'anonymous',
      backgroundImageCrossorigin: 'anonymous',
      'background-image-opacity': '1',
      backgroundImageOpacity: '1',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var cy = (window.cy = cytoscape({
    container: document.getElementById('embedded-design-6afd9029-60cf-4662-b031-cf4f9ab854fd-cy'),
