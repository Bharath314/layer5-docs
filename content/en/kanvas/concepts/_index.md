...
When creating a new design, by default its visibility will be set to **public** unless you are an active Layer5 Cloud subscriber, in which case you can change this default to **private**.
