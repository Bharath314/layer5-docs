...
![role-provider](/cloud/security/images/role-provider-admin.svg) {{% /card %}}
{{% card %}}
...
{{< cardpane >}} {{% card %}}
![team-admins-and-manager](/cloud/security/images/team-roles.svg) {{% /card %}}
{{< /cardpane >}}
...
For more information, see [Teams](/cloud/identity/teams). {{< /alert >}}
