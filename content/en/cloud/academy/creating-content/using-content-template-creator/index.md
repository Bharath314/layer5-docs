...
- **Organization Boundary Protection**: Only users within your
  [organization](https://docs.layer5.io/cloud/identity/organizations/) can use
  this invitation
...
3. **Roles**: Defaults to "Academy Learner" -
   [Learn more about Academy roles](https://docs.layer5.io/cloud/security/roles/academy-roles/)
...
- **No Teams Available**: If your organization has no teams,
  [create them](https://docs.layer5.io/cloud/identity/teams/) first. Users will
  be added to all successfully configured teams
